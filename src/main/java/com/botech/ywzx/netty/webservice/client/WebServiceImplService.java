 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webservice.netty.io.botech.com/", 
wsdlLocation = "http://127.0.0.1:7499/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.netty.io.botech.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:7499/webservice?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://webservice.netty.io.botech.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.netty.io.botech.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
